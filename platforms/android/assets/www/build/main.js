...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_nearby_nearby__ = __webpack_require__(114);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_all_packages_all_packages__ = __webpack_require__(110);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_help_help__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_login_login__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__ionic_native_geolocation__ = __webpack_require__(51);
...
var PackagedetailPage = (function () {
    function PackagedetailPage(navCtrl, navParams, geolocation, zone, loadingCtrl, platform, http, alertCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.geolocation = geolocation;
        this.zone = zone;
    ...
    PackagedetailPage.prototype.sendRequest = function (PackageID) {
        var _this = this;
        setTimeout(function () {
            _this.http.get('http://localhost:5000/requestDelivery?PackageID=' + PackageID).map(function (res) { return res.json(); }).subscribe(function (response) {
                if (response.content == 'success') {
                    _this.presentErrorAlert("Request has been sent, awaiting response from Package sender", "Success");
                }
                else if (response.content == 'failed') {
                    _this.presentErrorAlert("Request denied the package has already been booked", "Success");
                }
            }, function (err) {
                console.log('error');
            });
    ...
    PackagedetailPage.prototype.presentErrorAlert = function (text, header) {
        var alert = this.alertCtrl.create({
            title: header,
            subTitle: text,
            buttons: ['Dismiss']
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__nearby_nearby__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__all_packages_all_packages__ = __webpack_require__(110);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
